...
| GET | /v1/school-admin/reports/exports | Report / Export | SCHOOL_ADMIN, PRINCIPAL | frontend/src/features/reports/api/reportExportsApi.ts | CURRENT_IMPLEMENTED |
| POST | /v1/school-admin/reports/exports | Report / Export | SCHOOL_ADMIN, PRINCIPAL | frontend/src/features/reports/api/reportExportsApi.ts | CURRENT_IMPLEMENTED |
| GET | /v1/super-admin/reports/exports/{jobId} | Report / Export | SUPER_ADMIN | frontend/src/features/super-admin/api/platformApi.ts | CURRENT_IMPLEMENTED |
| GET | /v1/super-admin/reports/exports | Report / Export | SUPER_ADMIN | frontend/src/features/super-admin/api/platformApi.ts | CURRENT_IMPLEMENTED |
| POST | /v1/super-admin/reports/exports | Report / Export | SUPER_ADMIN | frontend/src/features/super-admin/api/platformApi.ts | CURRENT_IMPLEMENTED |
| GET | /v1/super-admin/reports/schools | Report / Export | SUPER_ADMIN | NOT_FOUND_IN_CODEBASE | BACKEND_EXISTS_UI_NOT_SURFACED |
| GET | /v1/super-admin/reports/summary | Report / Export | SUPER_ADMIN | frontend/src/features/super-admin/api/platformApi.ts | CURRENT_IMPLEMENTED |
...
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/finance/api/feeApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/operations/finance/FeeController.java method financeCollections
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/finance/reports/collections" \
...
```json
{
  ...
  "path": "/v1/finance/reports/collections"
}
```
...
- Role audience: FINANCE_STAFF
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/finance/api/feeApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/operations/finance/FeeController.java method financeReportSummary
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/finance/reports/summary" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/finance/reports/summary"
}
```
...
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/reports/api/reportExportsApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/operations/report/ReportExportController.java method downloadExport
- Planned/future: No separate planned endpoint; gaps listed below.
...
| Param | Type | Required | Validation | Example | Notes |
| --- | --- | --- | --- | --- | --- |
| exportId | string | Yes | Must exist and be accessible in scope | exportId-id | Verified by service/controller scope checks where implemented. |
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/school-admin/reports/exports/sample-exportId/download" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/school-admin/reports/exports/{exportId}/download"
}
```
...
## Backend controller file
- backend/src/main/java/com/cloudcampus/operations/report/ReportExportController.java

## Backend service file
- backend/src/main/java/com/cloudcampus/operations/report/ReportExportService.java
...
- Role audience: SCHOOL_ADMIN, PRINCIPAL
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/reports/api/reportExportsApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/operations/report/ReportExportController.java method getExport
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/school-admin/reports/exports/sample-exportId" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/school-admin/reports/exports/{exportId}"
}
```
...
- Role audience: SCHOOL_ADMIN, PRINCIPAL
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/reports/api/reportExportsApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/operations/report/ReportExportController.java method listExports
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/school-admin/reports/exports" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/school-admin/reports/exports"
}
```
...
- Role audience: SCHOOL_ADMIN, PRINCIPAL
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/reports/api/reportExportsApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/operations/report/ReportExportController.java method requestExport
- Planned/future: No separate planned endpoint; gaps listed below.

## Authorization
- Authentication required: Yes, Bearer JWT.
- Roles allowed: SCHOOL_ADMIN, PRINCIPAL
- Permissions required: EXPORT_REPORTS
- MFA required: Yes at login for privileged role; endpoint-level freshness is CURRENT_PARTIAL.
- Scope required: school
- Super Admin allowed: No
- Tenant Admin allowed: No
...
## Example request
```bash
curl -X POST "http://127.0.0.1:18080/v1/school-admin/reports/exports" \
  -H "Authorization: Bearer <access-token>" \
  -H "Content-Type: application/json" \
  -d "{\"reportType\":\"STUDENT_DIRECTORY\",\"format\":\"CSV\",\"tenantId\":\"tenant-id\",\"schoolId\":\"school-id\"}"
```
...
- Backend implemented: backend/src/main/java/com/cloudcampus/platform/superadmin/control/SuperAdminPlatformController.java method reportExport
- Planned/future: No separate planned endpoint; gaps listed below.
...
| Param | Type | Required | Validation | Example | Notes |
| --- | --- | --- | --- | --- | --- |
| jobId | string | Yes | Must exist and be accessible in scope | jobId-id | Verified by service/controller scope checks where implemented. |
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/super-admin/reports/exports/sample-jobId" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/super-admin/reports/exports/{jobId}"
}
```
...
- Role audience: SUPER_ADMIN
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/super-admin/api/platformApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/platform/superadmin/control/SuperAdminPlatformController.java method reportExports
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/super-admin/reports/exports" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/super-admin/reports/exports"
}
```
...
- Role audience: SUPER_ADMIN
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/super-admin/api/platformApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/platform/superadmin/control/SuperAdminPlatformController.java method reportExportRequest
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X POST "http://127.0.0.1:18080/v1/super-admin/reports/exports" \
  -H "Authorization: Bearer <access-token>" \
  -H "Content-Type: application/json" \
  -d "{\"reportType\":\"STUDENT_DIRECTORY\",\"format\":\"CSV\",\"tenantId\":\"tenant-id\",\"schoolId\":\"school-id\"}"
```
...
- Backend implemented: backend/src/main/java/com/cloudcampus/platform/superadmin/control/SuperAdminPlatformController.java method schoolReports
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/super-admin/reports/schools" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/super-admin/reports/schools"
}
```
...
- Role audience: SUPER_ADMIN
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/super-admin/api/platformApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/platform/superadmin/control/SuperAdminPlatformController.java method reportsSummary
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/super-admin/reports/summary" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/super-admin/reports/summary"
}
```
...
- Role audience: SUPER_ADMIN
- Frontend used: NOT_FOUND_IN_CODEBASE
- Backend implemented: backend/src/main/java/com/cloudcampus/platform/superadmin/control/SuperAdminPlatformController.java method tenantReports
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/super-admin/reports/tenants" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/super-admin/reports/tenants"
}
```
...
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/tenant-admin/api/tenantReportsApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/platform/tenantadmin/report/TenantAdminReportController.java method schoolSummary
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/tenant-admin/reports/schools/sample-schoolId/summary" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/tenant-admin/reports/schools/{schoolId}/summary"
}
```
...
## Backend controller file
- backend/src/main/java/com/cloudcampus/platform/tenantadmin/report/TenantAdminReportController.java

## Backend service file
- backend/src/main/java/com/cloudcampus/platform/tenantadmin/report/TenantAdminReportService.java
...
- Role audience: TENANT_ADMIN
- Frontend used: CURRENT_IMPLEMENTED in frontend/src/features/tenant-admin/api/tenantReportsApi.ts
- Backend implemented: backend/src/main/java/com/cloudcampus/platform/tenantadmin/report/TenantAdminReportController.java method summary
- Planned/future: No separate planned endpoint; gaps listed below.
...
## Example request
```bash
curl -X GET "http://127.0.0.1:18080/v1/tenant-admin/reports/summary" \
  -H "Authorization: Bearer <access-token>"
```
...
```json
{
  ...
  "error": "Forbidden",
  "message": "Access denied for current role or scope.",
  "path": "/v1/tenant-admin/reports/summary"
}
```
