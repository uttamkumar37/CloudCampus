...
| Item | Detail | Status |
| --- | --- | --- |
| Human-readable name | Office Staff | CURRENT_IMPLEMENTED |
| Role enum value | OFFICE_STAFF | CURRENT_IMPLEMENTED |
...
| Typical users | Admission desk, office administrators, records staff | CURRENT_IMPLEMENTED |
| Business purpose | Manage admissions, enquiries, student records, documents, certificates, and office follow-ups where surfaced. | CURRENT_IMPLEMENTED |
| Risk level | medium | CURRENT_IMPLEMENTED |
| Data sensitivity level | student records, documents, admissions, and certificates | CURRENT_IMPLEMENTED |
...
- widgets/cards: Admissions, Documents, AI follow-ups
- metrics: CURRENT_IMPLEMENTED from role dashboard summary endpoint.
- API source: /v1/staff/dashboard/summary
...
- Method: GET
- Full endpoint: /v1/staff/dashboard/summary
- Purpose: Return role dashboard metrics, alerts, and activity.
- Current implementation status: CURRENT_IMPLEMENTED
- Auth required: Yes
- Role required: OFFICE_STAFF
...
| --- | --- | --- | --- | --- | --- | --- |
| Office records | OFFICE_STAFF | School office access | Use admissions/enquiries/students/documents/certificates | Office records change where APIs exist | DOCUMENT_CREATED where implemented | Many office APIs are planned/partial |
...
| --- | --- | --- | --- | --- | --- |
| OFFICE_STAFF login/session | Integration/UI | Login allowed or public flow | Login/MFA/hydrate /v1/me | Correct role/token/scope | CURRENT_PARTIAL |
| OFFICE_STAFF forbidden cross-role API | Security | Authenticated session | Call unauthorized endpoint | 403/401 | CURRENT_PARTIAL |
| OFFICE_STAFF scope isolation | Security | Two tenants/schools/children/classes | Access outside scope | 403/404 | CURRENT_PARTIAL |
| OFFICE_STAFF dashboard load | UI/API | Authenticated session | Open dashboard | Metrics or empty state | CURRENT_PARTIAL |
| OFFICE_STAFF AI guard | Security/API | AI policy states | View/approve/execute | Only allowed action proceeds | CURRENT_PARTIAL |
| OFFICE_STAFF report/export privacy | Security/API | Sensitive data exists | Request report/export | Scoped masked data only | PLANNED_RECOMMENDED |
...
| Item | Status | Notes |
| --- | --- | --- |
| Role enum documented | CURRENT_IMPLEMENTED | OFFICE_STAFF |
...
| Navigation documented | CURRENT_IMPLEMENTED | 7 screens |
