...
| Item | Detail | Status |
| --- | --- | --- |
| Human-readable name | Teacher | CURRENT_IMPLEMENTED |
| Role enum value | TEACHER | CURRENT_IMPLEMENTED |
...
| Scope level | class | CURRENT_IMPLEMENTED |
| Typical users | Subject teachers and class teachers | CURRENT_IMPLEMENTED |
| Business purpose | Manage assigned attendance, homework, exams, marks, notices, timetable, and AI teaching suggestions. | CURRENT_IMPLEMENTED |
| Risk level | medium | CURRENT_IMPLEMENTED |
| Data sensitivity level | assigned-class academic and student data | CURRENT_IMPLEMENTED |

## 2. Role responsibilities
- CURRENT_IMPLEMENTED: Use visible screens: Dashboard, My Classes, Attendance, Homework, Exams, Marks, Notices, Timetable, AI Suggestions.
- CURRENT_IMPLEMENTED: Call 32 backend endpoint(s) inferred for this role/scope.
- CURRENT_IMPLEMENTED: Quick actions: Mark attendance - Open assigned classes; Create homework - Prepare class work; Enter marks - Update exam scores; AI suggestions - Review teaching recommendations.
...
## 3. Role restrictions
- CURRENT_IMPLEMENTED: Must not access resources outside class scope.
...
- CURRENT_IMPLEMENTED: Must not access unrelated classes/students.
...
- class/section/subject rules: CURRENT_IMPLEMENTED via teacher assignments.
...
| --- | --- | --- | --- | --- | --- |
| Dashboard | dashboard | Yes | SESSION_SELF_MANAGE | /v1/teacher/dashboard/summary | CURRENT_IMPLEMENTED |
| My Classes | classes | Yes | SCREEN_CLASSES | /v1/teacher/dashboard/summary | CURRENT_IMPLEMENTED |
| Attendance | attendance | Yes | SCREEN_ATTENDANCE | /v1/teacher/attendance/sessions/{sessionId} | CURRENT_IMPLEMENTED |
| Homework | homework | Yes | SCREEN_HOMEWORK | /v1/teacher/homework/{homeworkId} | CURRENT_IMPLEMENTED |
| Exams | exams | Yes | SCREEN_EXAMS | /v1/teacher/exams/{examId}/results | CURRENT_IMPLEMENTED |
| Marks | marks | Yes | SCREEN_MARKS | /v1/teacher/dashboard/summary | CURRENT_IMPLEMENTED |
| Notices | notices | Yes | SCREEN_NOTICES | /v1/teacher/notices | CURRENT_IMPLEMENTED |
| Timetable | timetable | Yes | SCREEN_TIMETABLE | /v1/teacher/timetable | CURRENT_IMPLEMENTED |
| AI Suggestions | ai-suggestions | Yes | SCREEN_AI_SUGGESTIONS | /v1/teacher/dashboard/summary | CURRENT_IMPLEMENTED |

## 7. Dashboard details
- dashboard title: Teacher Overview
- widgets/cards: Mark attendance, Create homework, Enter marks, AI suggestions
- metrics: CURRENT_IMPLEMENTED from role dashboard summary endpoint.
- API source: /v1/teacher/dashboard/summary
...
| GET | /v1/teacher/assignments | Yes | TEACHER_VIEW | assigned class/section/subject | query params | TeacherAssignmentPortal response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/attendance/sessions/{sessionId} | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Attendance response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/attendance/sessions | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Attendance response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| POST | /v1/teacher/attendance/sessions | Yes | TEACHER_MANAGE | assigned class/section/subject | path params / JSON body | Attendance response/DTO | ATTENDANCE_SUBMITTED | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/dashboard/summary | Yes | TEACHER_VIEW | assigned class/section/subject | query params | DashboardSummary response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| POST | /v1/teacher/exams/{examId}/results | Yes | TEACHER_MANAGE | assigned class/section/subject | path params / JSON body | Exam response/DTO | EXAM_MARKS_RECORDED or EXAM_RESULTS_PUBLISHED | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/exams/{examId}/roster | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Exam response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/exams/{examId} | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Exam response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/exams | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Exam response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/homework/{homeworkId} | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Homework response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/homework | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Homework response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| POST | /v1/teacher/homework | Yes | TEACHER_MANAGE | assigned class/section/subject | path params / JSON body | Homework response/DTO | HOMEWORK_PUBLISHED | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/notices | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Notice response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
| GET | /v1/teacher/timetable | Yes | TEACHER_VIEW | assigned class/section/subject | query params | Timetable response/DTO | Read-only endpoint; explicit audit is CURRENT_PARTIAL unless service records read access. | CURRENT_IMPLEMENTED |
...
- Privacy notes: mask sensitive fields by role.
- Performance notes: broad lists must be paginated/indexed.
- Frontend caller file: frontend/src/features/teacher/api/teacherPortalApi.ts
- Backend controller file: backend/src/main/java/com/cloudcampus/academic/TeacherAssignmentPortalController.java
- Backend service file: CURRENT_PARTIAL service may be differently named
- Repository/query source: CURRENT_PARTIAL module-specific repository.
- Tests that cover it: backend/src/test/java/com/cloudcampus/academic/AcademicAssignmentFlowTest.java, backend/src/test/java/com/cloudcampus/people/staff/StaffProvisioningFlowTest.java, backend/src/test/java/com/cloudcampus/security/SchoolScopedControllerGuardCoverageTest.java, frontend/src/app/App.test.tsx, frontend/src/features/parent/pages/ParentLeaveRequestsPage.test.tsx, frontend/src/features/reports/pages/ReportExportsPage.test.tsx, frontend/src/features/super-admin/api/platformApi.test.ts, frontend/src/shared/api/httpClient.test.ts
- Gaps/TODOs: CURRENT_IMPLEMENTED

### GET /v1/teacher/attendance/sessions/{sessionId}
- Method: GET
- Full endpoint: /v1/teacher/attendance/sessions/{sessionId}
...
- Method: GET
- Full endpoint: /v1/teacher/attendance/sessions
- Purpose: Read attendance data.
- Current implementation status: CURRENT_IMPLEMENTED
- Auth required: Yes
- Role required: TEACHER
...
- Method: GET
- Full endpoint: /v1/teacher/dashboard/summary
...
- Repository/query source: CURRENT_PARTIAL module-specific repository.
- Tests that cover it: backend/src/test/java/com/cloudcampus/academic/AcademicAssignmentFlowTest.java, backend/src/test/java/com/cloudcampus/intelligence/ai/AiScopedRetrievalFlowTest.java, backend/src/test/java/com/cloudcampus/notification/InvitationEmailDeliveryFlowTest.java, backend/src/test/java/com/cloudcampus/operations/attendance/AttendanceFlowTest.java, backend/src/test/java/com/cloudcampus/operations/bulk/BulkJobFlowTest.java, backend/src/test/java/com/cloudcampus/operations/exam/ExamFlowTest.java, backend/src/test/java/com/cloudcampus/operations/homework/HomeworkFlowTest.java, backend/src/test/java/com/cloudcampus/operations/notice/NoticeFlowTest.java, backend/src/test/java/com/cloudcampus/operations/report/ReportExportFlowTest.java, backend/src/test/java/com/cloudcampus/operations/timetable/TimetablePortalFlowTest.java, backend/src/test/java/com/cloudcampus/people/staff/StaffProvisioningFlowTest.java, backend/src/test/java/com/cloudcampus/platform/tenantadmin/settings/TenantAdminSettingsFlowTest.java, backend/src/test/java/com/cloudcampus/portal/dashboard/DashboardSummaryFlowTest.java, backend/src/test/java/com/cloudcampus/school/SchoolSettingsFlowTest.java, backend/src/test/java/com/cloudcampus/security/HardCodedMainSchoolResolutionTest.java, backend/src/test/java/com/cloudcampus/security/SchoolScopedControllerGuardCoverageTest.java, frontend/src/app/App.test.tsx, frontend/src/features/academic/pages/AcademicAssignmentsPage.test.tsx, frontend/src/features/staff/pages/StaffProvisioningPage.test.tsx, frontend/src/features/tenant-admin/pages/TenantSettingsPage.test.tsx
- Gaps/TODOs: CURRENT_IMPLEMENTED

### POST /v1/teacher/exams/{examId}/results
- Method: POST
- Full endpoint: /v1/teacher/exams/{examId}/results
...
- Method: GET
- Full endpoint: /v1/teacher/exams/{examId}/roster
...
- Method: GET
- Full endpoint: /v1/teacher/exams/{examId}
- Purpose: Read exam/results data.
- Current implementation status: CURRENT_IMPLEMENTED
- Auth required: Yes
- Role required: TEACHER
...
- Method: GET
- Full endpoint: /v1/teacher/exams
- Purpose: Read exam/results data.
- Current implementation status: CURRENT_IMPLEMENTED
- Auth required: Yes
- Role required: TEACHER
...
- Method: GET
- Full endpoint: /v1/teacher/homework/{homeworkId}
...
- Method: GET
- Full endpoint: /v1/teacher/homework
- Purpose: Read homework data.
- Current implementation status: CURRENT_IMPLEMENTED
- Auth required: Yes
- Role required: TEACHER
...
- Method: GET
- Full endpoint: /v1/teacher/notices
...
- Method: GET
- Full endpoint: /v1/teacher/timetable
...
| --- | --- | --- | --- | --- | --- | --- |
| Daily teaching | TEACHER | Teacher assignment exists | Open attendance/homework/exams/marks | Assigned class records change | ATTENDANCE_SUBMITTED/HOMEWORK_*/EXAM_* | Unassigned classes denied |
...
| --- | --- | --- | --- | --- | --- |
| TEACHER login/session | Integration/UI | Login allowed or public flow | Login/MFA/hydrate /v1/me | Correct role/token/scope | CURRENT_PARTIAL |
| TEACHER forbidden cross-role API | Security | Authenticated session | Call unauthorized endpoint | 403/401 | CURRENT_PARTIAL |
| TEACHER scope isolation | Security | Two tenants/schools/children/classes | Access outside scope | 403/404 | CURRENT_PARTIAL |
| TEACHER dashboard load | UI/API | Authenticated session | Open dashboard | Metrics or empty state | CURRENT_PARTIAL |
| TEACHER AI guard | Security/API | AI policy states | View/approve/execute | Only allowed action proceeds | CURRENT_PARTIAL |
| TEACHER report/export privacy | Security/API | Sensitive data exists | Request report/export | Scoped masked data only | PLANNED_RECOMMENDED |
...
| Item | Status | Notes |
| --- | --- | --- |
| Role enum documented | CURRENT_IMPLEMENTED | TEACHER |
| Login/MFA behavior documented | CURRENT_IMPLEMENTED | login / no role MFA |
| Scope documented | CURRENT_IMPLEMENTED | class |
| Permissions documented | CURRENT_IMPLEMENTED | 9 rows |
| Navigation documented | CURRENT_IMPLEMENTED | 9 screens |
| APIs documented | CURRENT_IMPLEMENTED | 32 endpoints |
