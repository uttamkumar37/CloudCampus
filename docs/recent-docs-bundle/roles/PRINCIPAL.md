...
| Item | Detail | Status |
| --- | --- | --- |
| Human-readable name | Principal | CURRENT_IMPLEMENTED |
| Role enum value | PRINCIPAL | CURRENT_IMPLEMENTED |
...
| Typical users | Academic heads and principals | CURRENT_IMPLEMENTED |
| Business purpose | Review academics, approvals, results, attendance, staff/student reports, and high-impact AI suggestions. | CURRENT_IMPLEMENTED |
| Risk level | high | CURRENT_IMPLEMENTED |
| Data sensitivity level | school-wide academic and student performance data | CURRENT_IMPLEMENTED |

## 2. Role responsibilities
- CURRENT_IMPLEMENTED: Use visible screens: Dashboard, Teachers, Students, Attendance Review, Exams, Results Approval, AI Approvals, Reports.
- CURRENT_IMPLEMENTED: Call 87 backend endpoint(s) inferred for this role/scope.
- CURRENT_IMPLEMENTED: Quick actions: Review results - Open academic approvals; AI approvals - Review high-impact suggestions; View reports - Review school performance.
...
| Attendance Review | attendance | Yes | SCREEN_ATTENDANCE | /v1/school-admin/attendance/sessions/{sessionId} | CURRENT_IMPLEMENTED |
| Exams | exams | Yes | SCREEN_EXAMS | /v1/school-admin/exams/{examId}/publish | CURRENT_IMPLEMENTED |
| Results Approval | results | Yes | SCREEN_RESULTS | /v1/school-admin/exams/{examId}/results | CURRENT_IMPLEMENTED |
| AI Approvals | ai-suggestions | Yes | SCREEN_AI_SUGGESTIONS | /v1/school-admin/dashboard/summary | CURRENT_IMPLEMENTED |
| Reports | reports | Yes | SCREEN_REPORTS | /v1/school-admin/reports/exports/{exportId}/download | CURRENT_IMPLEMENTED |

## 7. Dashboard details
- dashboard title: Principal Overview
- widgets/cards: Review results, AI approvals, View reports
...
| --- | --- | --- | --- | --- | --- | --- |
| Academic review | PRINCIPAL | School context and MFA | Open attendance/exams/results/AI approvals | Academic review/approval where surfaced | CURRENT_PARTIAL | Principal approval APIs are partial by screen/module |
...
| --- | --- | --- | --- | --- | --- |
| PRINCIPAL login/session | Integration/UI | Login allowed or public flow | Login/MFA/hydrate /v1/me | Correct role/token/scope | CURRENT_PARTIAL |
| PRINCIPAL forbidden cross-role API | Security | Authenticated session | Call unauthorized endpoint | 403/401 | CURRENT_PARTIAL |
| PRINCIPAL scope isolation | Security | Two tenants/schools/children/classes | Access outside scope | 403/404 | CURRENT_PARTIAL |
| PRINCIPAL dashboard load | UI/API | Authenticated session | Open dashboard | Metrics or empty state | CURRENT_PARTIAL |
| PRINCIPAL AI guard | Security/API | AI policy states | View/approve/execute | Only allowed action proceeds | CURRENT_PARTIAL |
| PRINCIPAL report/export privacy | Security/API | Sensitive data exists | Request report/export | Scoped masked data only | PLANNED_RECOMMENDED |
