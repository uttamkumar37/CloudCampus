...
## Overview
Not a standalone hostel module yet. Current implementation stores hostel fields in Student Profile 360 logistics profile.

## Business Purpose
Track current student residential metadata until a dedicated hostel/room/warden module is built.
