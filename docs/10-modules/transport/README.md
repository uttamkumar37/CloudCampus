...
## Overview
Not a standalone transport module yet. Current implementation stores transport fields in Student Profile 360 logistics profile.

## Business Purpose
Track current student transport assignment metadata until a dedicated route/vehicle/stop module is built.
