...
## Overview
Partially implemented: parent portal endpoints and frontend pages exist; mobile provides a minimal login/home shell.

## Business Purpose
Expose a constrained child-centric view for guardians, including homework, notices, fees, results, timetable, and attendance.
...
## Entities
Implementation files indicate entities/repositories in these packages: `mobile, student, notice`.

## APIs
Detected endpoint method counts for related packages: ANY:9, DELETE:3, GET:16, PATCH:5, POST:6, PUT:2.
...
- `backend/src/main/java/com/cloudcampus/mobile/controller/ParentController.java`
- `backend/src/main/java/com/cloudcampus/mobile/service/ParentPortalService.java`
- `backend/src/main/java/com/cloudcampus/mobile/service/ParentPortalServiceImpl.java`
...
- ... 23 additional files omitted for focus
