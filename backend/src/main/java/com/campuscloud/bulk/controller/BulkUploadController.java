package com.campuscloud.bulk.controller;

import com.campuscloud.bulk.dto.BulkUploadResponse;
import com.campuscloud.bulk.service.BulkUploadService;
...
public class BulkUploadController {
    ...
    public ResponseEntity<Resource> downloadSampleWorkbook() {
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=campuscloud-bulk-upload-sample.xlsx")
