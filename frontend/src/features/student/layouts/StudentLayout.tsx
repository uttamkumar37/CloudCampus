...
import { getStudentMe } from '../api/studentPortalApi';
...
export function StudentLayout() {
  ...
  const studentName = me ? `${me.firstName} ${me.lastName}` : 'Student';
  ...
  const sidebar = (
    <nav className="flex flex-col gap-4 px-3 py-4 h-full" aria-label="Student portal navigation">
      ...
      <NavSection title="Academic">
        <NavItem to="/student/dashboard" icon={<DashboardIcon />} label="Dashboard" />
        <NavItem to="/student/timetable" icon={<TimetableIcon />} label="Timetable" />
        <NavItem to="/student/homework" icon={<HomeworkIcon />} label="Homework" />
        <NavItem to="/student/assignments" icon={<AssignmentsIcon />} label="Assignments" />
        <NavItem to="/student/results" icon={<ResultsIcon />} label="Results" />
        <NavItem to="/student/attendance" icon={<AttendanceIcon />} label="Attendance" />
      </NavSection>

      <NavSection title="Finance">
        <NavItem to="/student/fees" icon={<FeesIcon />} label="Fees" />
      </NavSection>

      <NavSection title="Communication">
        <NavItem to="/student/notices" icon={<BellIcon />} label="Notices" />
      </NavSection>

      <div className="mt-auto border-t border-gray-100 pt-4 space-y-0.5">
        <div className="px-3 pb-2">
          <p className="truncate text-xs font-medium text-gray-700">{studentName}</p>
