    ...
    <section className="space-y-8">
      ...
      <form onSubmit={handleSubmit} className="rounded-[20px] border border-slate-200 bg-white p-6">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <FormInput label="Username" value={form.username} onChange={(v) => handleChange('username', v)} />
          <FormInput label="Email" value={form.email} onChange={(v) => handleChange('email', v)} />
          <FormInput label="Password" type="password" value={form.password} onChange={(v) => handleChange('password', v)} />
